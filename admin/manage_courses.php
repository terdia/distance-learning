    ...
    <div id="mainContent">      
        <div class="topContent">   
         <div class="adminLogin">
            ...
            <footer><h5>Add New Course</h5></footer>
            <content>
            	<div id="success">
                ...
                <table width="100%" border="0" cellpadding="1">
                  <tr>
                    ...
                    <input type="text" name="txtModuleCode" id="txtModuleCode"
                    size="50"></td>
                  </tr>
                ...
                <p><input id="c_info" name="addCourseInfo" type="button"
                        style="float:right;" onclick="parseCourseAdd()"
                        class="btn" value="Add Course"> </p>
