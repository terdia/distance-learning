...
<head>
<meta charset="utf-8">
<title>Administrator's Zone | Course Information Request</title>
        ...
        <div class="topContent">   
         <div class="adminLogin">
            ...
            <header>
                ...
                <footer><h5>Additional Course Information Request</h5></footer>

            <content>
                <div class="result"><?php echo $helper->loadCourseRequest()?></div>
